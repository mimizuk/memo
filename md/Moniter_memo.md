# 4Kモニター購入メモ
## <a id="standard">基本性能 - 最低条件</a>
1. 4K UHD
1. 60Hz対応(端子が対応している必要あり)
1. HDCP2.2(4K放送受信に必須)    

* 上3つ全てに対応したHDMI2.0端子(最低1つは必須)
* 1,2に対応したHDMI2.0端子(4K配信受信不可でもいいからHDMI端子は複数あったほうが便利そう)  
* DisplayPort 1.4(4Kだけであれば1.2で良いが、HDRは1.4である必要がある)
...
* HDR10とは     
    * Ultra HD Blu-rayで採用されているHDR規格。
    * nit数はこれを採用しているBlu-rayによって変わる。  
    10,000nitが最大。
    * **映像側が採用している規格**のため、これに対応しているからといってそのモニタのnit数がすごいわけではない。モニターはモニターで個別に確認する必要がある。   
* HDR10+    
...
* **輝度**  
    ...
    * ピーク輝度/最大輝度 
        * 画面の一部だけを発光させた最大輝度    
        * 高ければ高いほうが良い。**一説には、モニター側がピーク輝度1000cd/m2程度には対応していないと、HDRの恩恵を完璧には受けられないとも。**    
...
### フリッカーフリー / フリッカーセーフ
画面のチラつきを抑える。目に優しい。    
フリーとセーフは似たような機能だけど両者別物。たぶんフリッカーフリーのほうが良い。  
フリッカーレスってなんだ。

### G-SYNC / FreeSync
### USB Type-C‎

## <a id="tv">液晶テレビは選択肢に入るのか？</a>
* 液晶テレビ(4K UHD)のメリット
